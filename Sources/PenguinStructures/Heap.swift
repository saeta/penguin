...
public struct _NullHeapIndexer<Element, Index>: _ConfigurableHeapIndexerProtocol, DefaultInitializable {
...
public struct _DictionaryHeapIndexer<Element: Hashable, Index>: _ConfigurableHeapIndexer, DefaultInitializable {
