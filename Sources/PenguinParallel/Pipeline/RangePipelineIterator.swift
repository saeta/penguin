...
extension PipelineSequence {
  ...
  ///      // Prints "(2, chimp)"
  ///
  public func enumerated() -> Zip2PipelineSequence<RangePipelineSequence, Self> {
...
extension PipelineIteratorProtocol {
  ...
  ///      // Prints "(2, chimp)"
  ///
  public func enumerated() -> Zip2PipelineIterator<RangePipelineIterator, Self> {
...
extension PipelineIterator {
  ...
  ///   integers.
  public static func range(from: Int = 0, to: Int? = nil, step: Int = 1) -> RangePipelineIterator {
  ...
  /// - Returns: A pipeline iterator that will incrementally produce a sequence of
  ///   integers.
  public static func range(_ range: ClosedRange<Int>) -> RangePipelineIterator {
  ...
  /// - Returns: A pipeline iterator that will incrementally produce a sequence of
  ///   integers.
  public static func range(_ range: Range<Int>) -> RangePipelineIterator {
