...
struct SmallSetStringColumnBuilder: ColumnBuilder {
  ...
  func finish() -> PColumn {
    PColumn(
      PTypedColumn(
        impl: PTypedColumnImpl.encoded(encoder, handles),
        nils: nils))
  }
  ...
  mutating func append(_ cell: CSVCell) {
    ...
    case let .raw(buf):
      ...
      case "T", "t":
        ...
        if (charR == "r" || charR == "R") && (charU == "u" || charU == "U")
          && (charE == "e" || charE == "E")
        {
          append(true)
          return
      ...
      case "F", "f":
        ...
        if (charA == "a" || charA == "A") && (charL == "l" || charL == "L")
          && (charS == "s" || charS == "S") && (charE == "e" || charE == "E")
        {
          append(false)
          return
        }
...
extension CSVColumnMetadata {
  fileprivate func makeColumn() -> ColumnBuilder {
    switch type {
    case .string:
