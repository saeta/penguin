...
extension Comparable {
  /// XCTests `Self`'s semantic conformance to `Comparable` using the `orderedExamples`.
  ///
  /// - Parameter orderedExamples: a collection of instances of `Self` in ascending order.
  static func checkComparableSemantics(_ orderedExamples: Self...) {
    precondition(!orderedExamples.isEmpty, "Must have non-empty set of orderedExamples.")

    for i in orderedExamples.indices {
      XCTAssert(orderedExamples[i] == orderedExamples[i], "\(orderedExamples[i])")
      XCTAssert(orderedExamples[i] <= orderedExamples[i], "\(orderedExamples[i])")
      XCTAssert(orderedExamples[i] >= orderedExamples[i], "\(orderedExamples[i])")
      XCTAssertFalse(orderedExamples[i] < orderedExamples[i], "\(orderedExamples[i])")
      XCTAssertFalse(orderedExamples[i] > orderedExamples[i], "\(orderedExamples[i])")
      XCTAssertFalse(orderedExamples[i] != orderedExamples[i], "\(orderedExamples[i])")

      for j in orderedExamples[orderedExamples.index(after: i)...].indices {
        // Equality checks.
        XCTAssertFalse(orderedExamples[i] == orderedExamples[j], "\(orderedExamples[i]), \(orderedExamples[j])")
        XCTAssert(orderedExamples[i] != orderedExamples[j], "\(orderedExamples[i]), \(orderedExamples[j])")
        ...
        // Commutative equality checks.
        XCTAssert(orderedExamples[j] != orderedExamples[i], "\(orderedExamples[i]), \(orderedExamples[j])")
        XCTAssertFalse(orderedExamples[j] == orderedExamples[i], "\(orderedExamples[i]), \(orderedExamples[j])")

        // Commutative comparison checks.
        XCTAssert(orderedExamples[j] > orderedExamples[i], "\(orderedExamples[i]), \(orderedExamples[j])")
        XCTAssert(orderedExamples[j] >= orderedExamples[i], "\(orderedExamples[i]), \(orderedExamples[j])")
        XCTAssertFalse(orderedExamples[j] < orderedExamples[i], "\(orderedExamples[i]), \(orderedExamples[j])")
        XCTAssertFalse(orderedExamples[j] <= orderedExamples[i], "\(orderedExamples[i]), \(orderedExamples[j])")
